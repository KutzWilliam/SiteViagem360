    ...
    <div class="container">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-8">
            <div class="card">
              <div style="background-color: #2d1278; text-align: center;" class="card-header text-white">Registrar
                reclamação:</div><br>
            ...
            <div class="card">
              <div style="background-color: #2d1278; text-align: center;" class="card-header text-white">Consultar
