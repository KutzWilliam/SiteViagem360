...
<body>
  ...
  <div class="container-fluid" id="container-account">
    <div class="container">
      <div style="background-color: #2d1278; text-align: center;" class="card-header text-white">Minha conta</div>
      <br>
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-4">
            <div class="card">
              <div style="background-color: #2d1278;" class="card-header text-white">Painel de acesso:</div>
              <div class="card-body">
                <li><a href="DASHBOARD" style="color: #2d1278;">Minha conta</a></li>
                <li><a href="MEUSVOOS" style="color: #2d1278;">Acessar meus vôos</a></li>
                <li><a href="MINHASRECLAMACOES" style="color: #2d1278;">Acessar minhas reclamações</a></li>
          ...
          <div class="col-sm-8">
            <div class="card">
              <div style="background-color: #2d1278; text-align: center;" class="card-header text-white">Dados da
    ...
    <div class="container">
      <div>
        <div class="card">
          <div style="background-color: #2d1278; text-align: center;" class="card-header text-white">Informações
            Importantes:</div><br>
          <div class="col-sm-12">
