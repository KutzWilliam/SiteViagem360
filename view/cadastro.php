...
<body>
  ...
  <div class="container">
    <div class="card-header text-white" style="background-color: #2d1278; text-align: center; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px;">Criar conta</div>
    <br>
    <div class="card-header text-white" style="background-color: #2d1278; border-top-right-radius: 20px; border-top-left-radius: 20px; ">Dados pessoais</div>
    ...
    <div class="card-header text-white" style="background-color: #2d1278;">Dados de login para sua conta</div>
    <div class="card-header">
    ...
    <div class="card-footer" style="border-bottom-right-radius: 20px; border-bottom-left-radius: 20px;">
      <div class="text-center">
        Já possui uma conta? <a href="LOGIN" style="color: #2d1278;">Faça login</a>
      </div>
    </div>
    </form>
