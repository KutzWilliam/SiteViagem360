    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card">
          ...
          <div style="background-color: #2d1278; border-top-right-radius: 20px; border-top-left-radius: 20px;" class="card-header text-white">Login</div>
          <div class="card-body">
          ...
          <div class="card-footer">
            <div class="text-center">
              Não tem uma conta? <a href="CADASTROUSUARIO" style="color: #2d1278;">Cadastre-se</a>
            </div>
          </div>
        </div>
      </div>
