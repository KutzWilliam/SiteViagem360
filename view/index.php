  ...
  <div class="container-fluid" id="container-Inicio">
    <div class="container">
      <div class="row" style="margin-left: 10%;">
        <div class="col-sm-4">
          <h2 style="margin-top:70px;">Voo com até 40% off</h2>
        ...
        <div class="col-sm-11" style="margin-top: 30px ;">
          <form action="PESQUISAVOO" method="POST" type="submit" name="formDestino" id="formDestino">
            ...
            <div class="row" style="margin-top: 20px;">
              <div class="col">
                <input type="text" class="form-control" id="origemVoo" oninput="pesquisar()" placeholder="Digite a Origem" name="OrigemVoo" required autocomplete="off">
