...
class Reclamacao
{
    ...
    public function listaReservasParaReclamacao()
    {
        try {
            ...
            $sql = $conn->prepare("SELECT CONCAT('Cod Reserva:',codReservaVoo,'|',' Numero Voo:',tv.numvoo) as reserva, codReserva FROM viagens360.tabelareserva tr, viagens360.tabelavoos tv WHERE tr.idvoo = tv.idvoo AND tr.idusuario = :idusuario AND tr.statusReserva like '%ATIVA%'");
            ...
            $sql2 = $conn->prepare("SELECT idReclamacao, codReserva, descricaoReclamacao, statusReclamacao FROM viagens360.tabelareclamacao where idUsuarioReclamacao = :idusuario");
    ...
    public function insereReclamacao()
    {
        ...
        try {
            ...
            $sql = $conn->prepare("INSERT INTO viagens360.tabelareclamacao ( idUsuarioReclamacao, codReserva, descricaoReclamacao, statusReclamacao) 
    ...
    public function deletaReclamacao()
    {
        ...
        try {
            ...
            $sql = $conn->prepare("UPDATE  viagens360.tabelareclamacao SET statusReclamacao = 'Cancelada'  WHERE idReclamacao = :idReclamacao");
