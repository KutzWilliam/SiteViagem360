...
class Usuario {
    ...
    public function cadastraUsuario(){   
        try{
            ...
            $sql = $conn->prepare ("insert into viagens360.tabelausuario (nomeUsuario, email, dtaNasc, paisNasc,  numTel, cpf, senha, sexo)
    ...
    public function login(){   
        try{
            $conn = Conexao::conectar();
            $sql = $conn->prepare ("select idUsuario, nomeUsuario from viagens360.tabelausuario where cpf = :cpfUsuario AND senha = :senha");
            $sql->bindParam("cpfUsuario",$cpf);
            $sql->bindParam("senha",$senha);
            $cpf = $this->cpf;
            $senha = $this->senha;
    ...
    public function listaDadosUsuario()
    {
        try {
            $conn = Conexao::conectar();
            $sql = $conn->prepare("SELECT nomeUsuario, email, dtaNasc, paisNasc, numTel, cpf, senha, sexo, senha FROM viagens360.tabelausuario WHERE idUsuario = :idUsuario;");
    ...
    public function atualizaCadastro(){   
        try{
            $conn = Conexao::conectar();
            $sql = $conn->prepare ("UPDATE viagens360.tabelausuario SET nomeUsuario = :nome, email= :emailUsuario , dtaNasc= :nascUsuario, 
