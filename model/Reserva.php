...
class Reserva
{
    ...
    public function listaReservas()
    {
        try {
            ...
            FROM viagens360.tabelareserva tr, viagens360.tabelavoos tv WHERE tr.idvoo = tv.idvoo AND tr.idusuario = :idusuario ");
    ...
    public function listaReservaCancelamento()
    {
        try {
            ...
            FROM viagens360.tabelareserva tr, viagens360.tabelavoos tv WHERE tr.idvoo = tv.idvoo AND idReserva = :idReserva");
    ...
    public function cancelaReserva()
    {
        ...
        try {
            ...
            $sql = $conn->prepare("UPDATE  viagens360.tabelareserva SET statusReserva = 'Cancelada'  WHERE idReserva = :idReserva");
            $sql->bindParam("idReserva", $idReserva);
            $idReserva = $this->idReserva;
